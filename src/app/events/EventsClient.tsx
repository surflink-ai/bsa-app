        ...
        {SCHEDULE_2026.map((e, i) => {
          ...
          return (
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
              ...
              <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 11, color: 'rgba(255,255,255,0.7)', marginTop: 4, textAlign: 'center', fontWeight: 500 }}>{safeDate(e.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</span>
              <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 9, color: 'rgba(255,255,255,0.35)', marginTop: 1, textAlign: 'center' }}>{e.location}</span>
            </div>
          )
        })}
      </div>
